...
reset:
    ...
    // Prescaler de 9.500.000 para una frecuencia de 10 Hz //El PC Cuenta 10 veces por segundo
    LDR R0,=9500000
    STR R0,[R1,#PR]

    // El valor del semperiodo para 1 Hz
    LDR R0,=5   //Defino que en el Match Register en 5, eso significa 
                //que cada 0,5 seg(medio seg) voy a estar recibiendo un match y un llamado a la interrupcion
    STR R0,[R1,#MR3]
    //Interrupción cada medio segundo
